  ...
  return (
    <Link key={postSlug} href={`/post/${postSlug}`} passHref>
      <div className="flex flex-col w-full cursor-pointer">
        <div className="flex items-start justify-between w-full mb-1.5 sm:mb-2 sm:items-center">
          <div className="w-80 sm:w-auto">
            <span className="text-lg font-bold">{postTitle}</span>
          </div>

          <div className="flex mt-1.5 ml-4 text-gray-600 dark:text-gray-400 sm:mt-0">
            <ViewIcon />
